  ...
  updateQuantity(line, quantity, name, variantId) {
    ...
    fetch(`${_UMG.shopSettings.routes.cart_change_url}`, {
      ...
      .then((state) => {
        ...
        if (
          ...
          if (typeof updatedValue === "undefined") {
            message = window._UMG.shopSettings.cartStrings.error;
          } else {
            message =
              window._UMG.shopSettings.cartStrings.quantityError.replace(
                "[quantity]",
                updatedValue
              );
          }
      ...
      .catch(() => {
        ...
        errors.textContent = window._UMG.shopSettings.cartStrings.error;
      })
      .finally(() => {
      ...
      constructor() {
        ...
        this.addEventListener(
          ...
          debounce((event) => {
            ...
            fetch(`${_UMG.shopSettings.routes.cart_update_url}`, {
              ...fetchConfig(),
              ...{ body },
            })
          }, ON_CHANGE_DEBOUNCE_TIMER)
